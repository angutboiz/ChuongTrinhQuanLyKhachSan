...
VALUES ('101', 'Standard', 100, 'Available'),
       ('102', 'Deluxe', 150, 'Available'),
       ('103', 'Suite', 200, 'Occupied'); -- Ví dụ về phòng đã được đặt
...
INSERT INTO Service (sername, serdetail, sertax)
VALUES ('Breakfast', 'Continental breakfast', 10),
       ('Laundry', 'Wash and fold', 20);
